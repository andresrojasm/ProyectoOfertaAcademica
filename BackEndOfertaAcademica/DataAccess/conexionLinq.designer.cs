...
namespace BackEndOfertaAcademica.DataAccess
{
	...
	public partial class GET_LISTA_OFERTA_ACADEMICAResult
	{
		...
		private int _ID_CUATRIMESTRE;
		
		private int _CEDULA_DOCENTE;
		
		private System.DateTime _AÑO;
		...
		public GET_LISTA_OFERTA_ACADEMICAResult()
		{
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ID_CUATRIMESTRE", DbType="Int NOT NULL")]
		public int ID_CUATRIMESTRE
		{
			get
			{
				return this._ID_CUATRIMESTRE;
			}
			set
			{
				if ((this._ID_CUATRIMESTRE != value))
				{
					this._ID_CUATRIMESTRE = value;
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CEDULA_DOCENTE", DbType="Int NOT NULL")]
		public int CEDULA_DOCENTE
		{
			get
			{
				return this._CEDULA_DOCENTE;
			}
			set
			{
				if ((this._CEDULA_DOCENTE != value))
				{
					this._CEDULA_DOCENTE = value;
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AÑO", DbType="DateTime NOT NULL")]
