...
AS BEGIN
INSERT INTO [dbo].[OFERTA_ACADEMICA]([NOMBREOFERTA],[ID_CURSO],[ID_SEDE],[ID_CUATRIMESTRE],[CEDULA_DOCENTE],[AÑO],[ID_HORARIO],[GRUPO],[ESTADO],[USUARIO])
     VALUES(@NOMBREOFERTA,@ID_CURSO,@ID_SEDE,@ID_CUATRIMESTRE,@CEDULA_DOCENTE,@AÑO,@ID_HORARIO,@GRUPO,@ESTADO,@USUARIO)
END
GO
...
CREATE PROCEDURE SP_RELACION_CD @ID_RECD INT, @ID_CURSO VARCHAR, @CEDULA INT
AS BEGIN 
...
CREATE PROCEDURE NEWSEDEDOCENTE @ID_SEDE INT, @CEDULA INT
AS BEGIN
