...
CREATE TABLE REQUISITOS(
	ID_RQ INT IDENTITY(1,1) NOT NULL,
	ID_CURSO VARCHAR(10) NOT NULL,
	ID_REQUISITO VARCHAR(10) NOT NULL,
	CONSTRAINT PK_ID_RQ PRIMARY KEY(ID_RQ),
	CONSTRAINT FK_CURSO_REQUISITOS_IDCURSO FOREIGN KEY(ID_CURSO) REFERENCES CURSO(ID_CURSO),
	CONSTRAINT FK_CURSO_REQUISITOS_IDREQUESITO FOREIGN KEY(ID_REQUISITO) REFERENCES CURSO(ID_CURSO),
)
GO
